...
# 데이터 병합
merged_data = pd.merge(dividend_data, performance_data, on='etf_tck_cd', how='inner')

# 2. 필요한 열만 추출
X = merged_data[['mm1_tot_pft_rt', 'mm3_tot_pft_rt', 'yr1_tot_pft_rt', 
                 'shpr_z_sor', 'vty_z_sor', 'mxdd_z_sor']]
